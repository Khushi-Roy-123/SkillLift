...
import { askSkillLift } from '../services/geminiService';
...
const AskSkillLiftPage: React.FC = () => {
  ...
  const handleSend = async (messageToSend?: string) => {
    ...
    const responseText = await askSkillLift(history.slice(0, -1), currentInput);
  ...
  return (
    <div className="flex flex-col h-full max-w-4xl mx-auto animate-fade-in-up">
      <div className="relative text-center mb-6">
        <h1 className="text-3xl font-bold text-gray-900">Ask SkillLift</h1>
...
export default AskSkillLiftPage;
