...
import { ChatIcon, BriefcaseIcon, GamepadIcon, SparklesIcon, DocumentTextIcon, LightbulbIcon, ForumIcon, TrophyIcon, UserIcon, Logo, LinkedinIcon, GithubIcon } from '../components/icons';
        ...
        <div className="bg-sky-50 text-gray-800">
            ...
            <header className="absolute top-0 left-0 right-0 z-50 py-4 px-6 md:px-12 flex justify-between items-center">
                <div className="flex items-center space-x-3">
                    ...
                    <h1 className="text-2xl font-bold text-white [text-shadow:0_1px_3px_rgb(0_0_0_/_0.5)]">SkillLift</h1>
                </div>
            ...
            <main>
                ...
                {/* Why Section */}
                <section id="why-skilllift" className="py-20 px-6 bg-white">
                ...
                <section id="features" className="py-20 px-6 bg-sky-50">
                    <div className="max-w-6xl mx-auto">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            <FeatureCard icon={ChatIcon} title="Ask SkillLift">Your personal AI mentor. Get instant answers to your STEM questions, 24/7.</FeatureCard>
                            ...
                            <FeatureCard icon={GamepadIcon} title="SkillQuest">Level up your skills with our gamified career roadmaps. Earn XP and badges!</FeatureCard>
                            <FeatureCard icon={LightbulbIcon} title="Inspiration Hub">Get inspired by the stories of pioneering women in history.</FeatureCard>
                            ...
                            <div>
                             ...
                             <div>
                                ...
                                <div className="flex mt-4 space-x-4">
                                    <a href="https://www.linkedin.com/in/khushi-roy-b27815371/" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-blue-600 transition-colors"><span className="sr-only">LinkedIn</span><LinkedinIcon className="w-6 h-6" /></a>
                                    <a href="https://github.com/Khushi-Roy-123" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-blue-600 transition-colors"><span className="sr-only">GitHub</span><GithubIcon className="w-6 h-6" /></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="mt-8 border-t border-gray-200 pt-8 text-center">
                        <p className="text-sm text-gray-500">&copy; {new Date().getFullYear()} SkillLift. All rights reserved. Built to empower.</p>
                    </div>
                </div>
            </footer>
        </div>
