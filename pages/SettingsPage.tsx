    ...
    return (
        <div className="animate-fade-in-up space-y-8 max-w-4xl mx-auto">
            ...
            <div className="bg-white p-6 md:p-8 rounded-2xl border border-gray-200">
                 ...
                 <p className="text-gray-600 mb-6">Choose which emails you want to receive from SkillLift. Note: This is a frontend demonstration. No actual emails will be sent.</p>
