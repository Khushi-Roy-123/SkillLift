...
export type Page = 'Home' | 'Ask SkillLift' | 'Opportunities' | 'Inspiration Hub' | 'SkillQuest' | 'Resume Tips' | 'Community Forum' | 'Settings' | 'Wellbeing Hub' | 'Life Balance';
...
export interface User {
    ...
    tasks?: TaskItem[]; // Optional for backward compatibility
    hydration?: {
        count: number;
        goal: number;
        lastUpdated: string;
